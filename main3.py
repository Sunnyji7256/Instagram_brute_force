...
def display_banner():
    print("=" * 60)
    print("  ____  _  _  ____  ____  ____  ____  _  _  ____  ____  ____  ")
    print(" (  _ \\\/ )(  _ \ __)/ ___)/ ___)/ )( \ __)(  _ \ _ \\ ")
    print("  )   /\\  /  ) __/ ) _) \\___ \\\\___ \ \\/ ( ) _)  )   / ) __/ ")
    print(" (__\\_) (__) (__)  (____)(____/(____/(____/(____)(__\\_)(__)   ")
    print(" " * 15 + "Sunny Ji")
    print("=" * 60)

def display_footer():
    print("=" * 60)
    print(" " * 20 + "End of Attempt")
    print("=" * 60)
